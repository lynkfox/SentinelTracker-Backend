...
class Test_with_allies:
    ...
    def test_returns_valid_string_with_more_than_one_hero(self):
        ...
        assert (
            test_response
            == "heroTeams.hero_one=`Absolute Zero`, heroTeams.hero_two=`Bunker`"
        )
    ...
    def test_same_order_if_positional_true(self):
        ...
        assert (
            test_response
            == "gameDetails.hero_one=`Writhe`, gameDetails.hero_two=`Bunker`"
        )

    def test_sorts_if_positional_left_to_default(self):
        test_response = with_allies(["Writhe", "Bunker"], Type.HERO)
        assert (
            test_response == "heroTeams.hero_one=`Bunker`, heroTeams.hero_two=`Writhe`"
        )
    ...
    def test_villains_points_to_opponent_table(self):
        ...
        assert (
            test_response
            == "opponents.villain_one=`Baron Blade`, opponents.villain_two=`Ermine`"
        )
