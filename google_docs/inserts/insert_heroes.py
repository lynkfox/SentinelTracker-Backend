...
HEROES_TO_INSERT = [
    ...
    HeroInsert(
        Hero.baccarat,
        BoxSet.CAULDRON,
        AlternateTags.ace_of_sorrows
    ),
    HeroInsert(
        Hero.baccarat,
        BoxSet.CAULDRON,
        AlternateTags.ace_of_swords
    ),
    HeroInsert(
        Hero.doc_havoc,
        BoxSet.CAULDRON
    ...
    HeroInsert(
        Hero.doc_havoc,
        BoxSet.CAULDRON,
        AlternateTags.alt_2199
    ),
    HeroInsert(
        Hero.doc_havoc,
        BoxSet.CAULDRON,
        AlternateTags.first_response
    ),
    HeroInsert(
        Hero.the_knight,
        BoxSet.CAULDRON
    ...
    HeroInsert(
        Hero.lady_of_the_wood,
        BoxSet.CAULDRON,
        AlternateTags.season_of_change
    ),
    HeroInsert(
        Hero.malichae,
        BoxSet.CAULDRON
    ...
    HeroInsert(
        Hero.quicksilver,
        BoxSet.CAULDRON,
        AlternateTags.the_uncanny
    ),
    HeroInsert(
        Hero.quicksilver,
        BoxSet.CAULDRON,
        AlternateTags.renegade
    ),
    HeroInsert(
        Hero.starlight,
        BoxSet.CAULDRON
    ...
    HeroInsert(
        Hero.starlight,
        BoxSet.CAULDRON,
        AlternateTags.genesis
    ),
    HeroInsert(
        Hero.starlight,
        BoxSet.CAULDRON,
        AlternateTags.nightlore_council
    ),
    HeroInsert(
        Hero.the_stranger,
        BoxSet.CAULDRON
    ...
    HeroInsert(
        Hero.cypher,
        BoxSet.CAULDRON_EXPERIMENTAL,
        AlternateTags.swarming_protocol
    ),
    HeroInsert(
        Hero.titan,
        BoxSet.CAULDRON_EXPERIMENTAL
    ...
    HeroInsert(
        Hero.drift,
        BoxSet.CAULDRON_ADRIFT,
        AlternateTags.alt_1929_2199
    ),
    HeroInsert(
        Hero.drift,
        BoxSet.CAULDRON_ADRIFT,
        AlternateTags.through_the_breach
    ),
    HeroInsert(
        Hero.gargoyle,
        BoxSet.CAULDRON_ADRIFT
