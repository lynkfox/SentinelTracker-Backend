...
from common.models.character_enums import AlternateTags, Villain, VILLAIN_DISPLAY_MAPPING, ALTERNATE_TAG_DISPLAY_MAPPING
...
VILLAINS_TO_INSERT = [
    ...
    VillainInsert(
        Villain.citizen_dawn,
        BoxSet.DEFINITIVE_EDITION,
        AlternateTags.sunrise
    ),
    VillainInsert(
        Villain.citizens_hammer_and_anvil,
        BoxSet.VILLAINS
    ),
    VillainInsert(
        Villain.dark_mind,
    ...
    VillainInsert(
        Villain.gloomweaver,
        BoxSet.INFERNAL_RELICS,
        AlternateTags.skinwalker
    ),
    VillainInsert(
        Villain.grand_warlord_voss,
        BoxSet.ENHANCED_EDITION
    ),
    VillainInsert(
        Villain.grand_warlord_voss,
    ...
    VillainInsert(
        Villain.grand_warlord_voss,
        BoxSet.DEFINITIVE_EDITION,
        AlternateTags.censor
    ),
    VillainInsert(
        Villain.greazer_clutch,
        BoxSet.VILLAINS
    ),
    VillainInsert(
        Villain.infinitor,
    ...
    VillainInsert(
        Villain.matriarch,
        BoxSet.DEFINITIVE_EDITION,
        AlternateTags.mocktriarch
    ),
    VillainInsert(
        Villain.miss_information,
        BoxSet.MISS_INFORMATION
    ),
    VillainInsert(
        Villain.miss_information,
        BoxSet.MISS_INFORMATION,
    ...
    VillainInsert(
        Villain.omnitron,
        BoxSet.DEFINITIVE_EDITION,
        AlternateTags.definitive_cosmic
    ),
    VillainInsert(
        Villain.the_operative,
        BoxSet.VILLAINS
    ),
    VillainInsert(
        Villain.plague_rat,
