...
class Hero(Character):
    ...
    southwest_sentinels = "southwest_sentinels"
    stuntman = "stuntman"
    tachyon = "tachyon"
    tempest = "tempest"
    unity = "unity"
...
LOCATION_DISPLAY_MAPPING = {
    ...
    Location.madame_mittermeiers: "Madame Mittermeier's Fantastic Festival of Conundrums and Curiosities",
    Location.maerynian_refuge: "Maerynian Refuge",
    Location.magmaria: "Magmaria",
    Location.megalopolis: "Megalopolis",
    Location.mobile_defense_platform: "Mobile Defense Platform",
    Location.mordengrad: "Mordengrad",
    Location.nexus_of_the_void: "Nexus of the Void",
    Location.omnitron_iv: "Omnitron-IV",
    Location.pike_industrial_complex: "Pike Industrial Complex",
    Location.realm_of_discord: "Realm of Discord",
    Location.rook_city: "Rook City",
    Location.ruins_of_atlantis: "Ruins of Atlantis",
    Location.silver_gulch_1883: "Silver Gulch: 1883",
    Location.temple_of_zhu_long: "The Temple of Zhu Long",
    Location.time_cataclysm: "Time Cataclysm",
    Location.tomb_of_anubis: "The Tomb of Anubis",
    Location.wagner_mars_base: "Wagner Mars Base",
    Location.blackwood_forest: "Blackwood Forest",
    Location.f_s_c_continuance_wanderer: "F.S.C Continuance Wanderer",
    Location.halberd_experimental_research_center: "Halberd Experimental Research Center",
    Location.northspar: "Northspar",
    Location.st_simeons_catacombs: "St. Simeons Catacombs",
    Location.wandering_isle: "Wandering Isle",
    Location.catchwater_harbor_1929: "Catchwater Harbor: 1929",
    Location.chasm_of_a_thousand_nights: "Chasm of a Thousand Nights",
    Location.nightlore_citadel: "Nightlore Citadel",
    Location.vault_5: "Vault 5",
    Location.windmill_city: "Windmill City",
    Location.cybersphere: "Cybersphere",
    Location.superstorm_akela: "Superstorm Akela",
    Location.diamond_manor: "Diamond Manor",
}
